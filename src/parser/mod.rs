...
pub struct ComrakExtensionOptions {
    ...
    /// Whether the headers generated by the header IDs extension should be marked as aria-hidden.
    /// If false the aria-hidden property will be added (default), if true aria_hidden is not added.
    ///
    /// ```
    /// # use comrak::{markdown_to_html, ComrakOptions};
    /// let mut options = ComrakOptions::default();
