        ...
        'yyl: loop {
            match yystate {
                ...
                6 => {
                    ...
                    match yych {
                        0x00..=0x08 | 0x0B..=0x0C | 0x0E..=0x1F | 0x21..=0x39 | 0x3B..=0xFE => {
                            yystate = 5;
                            continue 'yyl;
                        }
                        0x09 | 0x20 => {
...

    {
        ...
        'yyl: loop {
            match yystate {
                ...
                27 => {
                    return Some(crate::nodes::AlertType::Tip);
                }
                28 => {
                    yych = unsafe {
                        if cursor < len {
                ...
                31 => {
                    return Some(crate::nodes::AlertType::Note);
                }
                32 => {
                    yych = unsafe {
                        if cursor < len {
                ...
                39 => {
                    return Some(crate::nodes::AlertType::Caution);
                }
                40 => {
                    yych = unsafe {
                        if cursor < len {
                ...
                41 => {
                    return Some(crate::nodes::AlertType::Warning);
                }
                42 => {
                    yych = unsafe {
                        if cursor < len {
                ...
                43 => {
                    return Some(crate::nodes::AlertType::Important);
                }
                _ => panic!("internal lexer error"),
            }
        }
        ...
        'yyl: loop {
            match yystate {
                0 => {
                    ...
                    cursor += 1;
                    match yych {
                        0x2B | 0x2D | 0x30..=0x39 | 0x41..=0x5A | 0x5F | 0x61..=0x7A => {
                            yystate = 3;
                            continue 'yyl;
                        }
                        _ => {
                ...
                3 => {
                    ...
                    match yych {
                        0x2B | 0x2D | 0x30..=0x3A | 0x41..=0x5A | 0x5F | 0x61..=0x7A => {
                            yystate = 5;
                            continue 'yyl;
                        }
                        _ => {
